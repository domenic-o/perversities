...
\begin{rem}
The proof of Proposition \ref{grad} makes it clear the meaning of the otherwise obscure condition in the definition of grading abelian $\Z$-slicing: the condition on a shift by at least 2 in the definition of strict perversity is traded for a orthogonality condition in the slicing. 
\end{rem}
