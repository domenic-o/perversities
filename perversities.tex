...
\end{proof}
Although $f_*$ maps $J$-slicing to $J'$-slicings, it does not necessarily map Bridgeland $J$-slicings to Bridgeland $J'$-slicings. However, if a Bridgeland slicing $\tee$ is particularly well behaved  with respect to a given mapof $\Z$-sets $f$, then $f_*\tee$ will again be a Bridgeland slicing. We make this precise in the following definition and proposition.
\begin{defn}
Let $J,J'$ be $\Z$-tosets, and let $J \overset{f}{\longrightarrow} J'$ be a map of $\Z$-sets (not necessarily a map of $\mathbb{Z}$-posets), and let $\tee$ be a $J$-slicing on $\mathscr{D}$. We say that $f$ is $\tee$-monotone if $\phi\leq \psi$ and $\tee([\phi,+\infty))\leq \tee((\psi+1,+\infty))$ together imply $f(\phi)\leq f(\psi)$.
\end{defn}

The condition of being $\tee$-monotone is clearly weaker than the condition of being monotone: a monotone map $f\colon J\to J'$ is $\tee$-monotone with respect to every $J$-slicing $\tee$.

\begin{prop}\label{pipp0}
Let $J,J'$ be $\Z$-tosets and $\tee$ be a Bridgeland $J$-slicing of $\mathscr{D}$. If a morphism of $\Z$-sets $J \overset{f}{\longrightarrow} J'$ is $\tee$-monotone, then $f_*\tee$ is a Bridgeland $J'$-slicing of $\mathscr{D}$. Moreover, for every $j\in J'$ we have $\mathscr{D}_{f_*\tee;j}=\mathscr{D}_{\tee;f^{-1}(j)}$.
\end{prop}
